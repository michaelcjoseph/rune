...
> project is built **test-first** — each code task's test strategy is tracked in
> tasks.md, QA authors required tests before coder implementation, and closeout requires
> the task's validation to pass.
