...
- [ ] Write the test suite for **merge-interview-into-pm** — test-plan.md §1.
- [ ] Write the test suite for **retire-specified-enough-gate** — test-plan.md §1.
- [ ] Write the test suite for **persist-spec-approval-state** — test-plan.md §1.
